...
public class UsbService extends Service {
    ...
    public static final int BAUD_RATE = 115200; // BaudRate. Change this value if you need
    public static boolean SERVICE_CONNECTED = false;

    public IBinder binder = new UsbBinder();
    ...
    public int getBaudRate() {
        ...
        if (serialPort != null) {
            if (serialPort.open()) {
                return serialPort.getInitialBaudRate();
            }
        }
        return 0;
    }
