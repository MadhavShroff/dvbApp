...
//        byte[] bytes = Arrays.copyOfRange(byteBuffer.array(), 172, 204);
        ...
        StaticStore.System.systemVersion = String.valueOf(new char[]{(char)byteBuffer.get(204), (char)byteBuffer.get(205), (char)byteBuffer.get(206), (char)byteBuffer.get(207), (char)byteBuffer.get(208), (char)byteBuffer.get(209)});
        try {
